...
export const CAPTION_STYLES: CaptionStyle[] = [
  ...
  },
  {
    ...
    label: 'Highlight',
    preview: 'text-white font-black uppercase',
    highlightClass: 'text-[#FFE500]',
    baseScore: 12,
    animation: 'highlight',
    animLabel: 'Highlight',
  },
  {
    // Anton (Google Fonts) — open-source consensus font for shorts captions.
    // Same per-word highlight technique as 'highlight', heavier condensed font.
    id: 'anton',
    label: 'Anton',
    preview: 'text-white font-black uppercase',
    highlightClass: 'text-[#FFE500]',
