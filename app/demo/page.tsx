...
export const metadata: Metadata = {
  ...
  description:
    'Try Viral Animal in 30 seconds: change caption styles, see viral score — no signup required.',
  openGraph: {
...
const jsonLd = {
  ...
  description: 'Try Viral Animal in 30 seconds: change caption styles, see viral score — no signup required.',
