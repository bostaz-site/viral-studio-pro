        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 text-muted-foreground">
              ...
              <li><strong className="text-foreground">Plan Pro ($19/mois)</strong> : 30 vidéos par mois, clips jusqu&apos;à 2 minutes, sans watermark, branding personnalisé</li>
              <li><strong className="text-foreground">Plan Studio ($24/mois)</strong> : 120 vidéos par mois (90 + 30 bonus de bienvenue), clips jusqu&apos;à 2 minutes, split-screen, distribution multi-plateforme</li>
