...
## About
- [about/founder.md](about/founder.md) — Who Samy is, his background, red lines, communication style
- [about/product.md](about/product.md) — Viral Animal vision (4 stages), launch reality, stack

## Wiki — System
- [wiki/system/render.md](wiki/system/render.md) — VPS render pipeline, tiers, contract, diversify, SFX, watermark
- [wiki/system/distribution.md](wiki/system/distribution.md) — Autofarm, quality gates, cadence, caption engine, gate UI
- [wiki/system/platforms.md](wiki/system/platforms.md) — OAuth flows (TikTok/YouTube/Instagram/Facebook), publish, gating
...
- [wiki/plans/revue-vendredi.md](wiki/plans/revue-vendredi.md) — Questions produit ouvertes, passées en revue le vendredi
...
- raw/system-reference/ — 27 original SYSTEM-REFERENCE*.md files
- raw/sessions/ — Auto-generated session summaries
