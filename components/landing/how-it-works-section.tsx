    ...
    <section className="py-20 px-6 border-t border-border/30">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Cr&eacute;e ton premier clip viral en 3 &eacute;tapes</h2>
          <p className="text-muted-foreground mt-3 text-lg">De ton stream Twitch &agrave; TikTok — en moins de 5 minutes</p>
        </div>
        ...
        <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <span className="inline-block text-xs font-bold text-purple-400 uppercase tracking-wider mb-2">&Eacute;tape 1</span>
              <h3 className="text-2xl font-bold text-foreground mb-3">Choisis un clip de stream</h3>
              <p className="text-muted-foreground leading-relaxed">Parcours les meilleurs moments Twitch et YouTube Gaming tri&eacute;s par score viral. L&apos;IA identifie automatiquement les moments les plus engageants.</p>
            </div>
                ...
                {[
                  ...
                  <div key={clip.name} className={cn('flex items-center gap-3 p-2 rounded-lg bg-gradient-to-r', clip.color)}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[8px] text-muted-foreground">il y a 2h &middot; 45s</p>
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="rounded-xl border border-border/50 bg-card/60 overflow-hidden shadow-lg md:order-1 order-2">
              <div className="flex items-center gap-1.5 px-3 py-2 border-b border-border/50 bg-card/80">
                ...
                <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/60" />
                <div className="w-2.5 h-2.5 rounded-full bg-green-500/60" />
                <span className="text-[10px] text-muted-foreground/50 ml-2">&Eacute;diteur — Viral Studio Pro</span>
              </div>
            ...
            <div className="md:order-2 order-1">
              <span className="inline-block text-xs font-bold text-blue-400 uppercase tracking-wider mb-2">&Eacute;tape 2</span>
              <h3 className="text-2xl font-bold text-foreground mb-3">Personnalise ton clip</h3>
              <p className="text-muted-foreground leading-relaxed">Sous-titres karaok&eacute; (9 styles), split-screen avec vid&eacute;o satisfaisante, et analyse IA du score viral. Tout se configure en quelques clics.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <span className="inline-block text-xs font-bold text-emerald-400 uppercase tracking-wider mb-2">&Eacute;tape 3</span>
              <h3 className="text-2xl font-bold text-foreground mb-3">Exporte et publie</h3>
              <p className="text-muted-foreground leading-relaxed">T&eacute;l&eacute;charge en 9:16 optimis&eacute; TikTok/Reels/Shorts ou publie directement sur tes plateformes. Ton clip est pr&ecirc;t en moins de 5 minutes.</p>
            </div>
            {/* Mockup: export */}
            <div className="rounded-xl border border-border/50 bg-card/60 overflow-hidden shadow-lg">
              <div className="flex items-center gap-1.5 px-3 py-2 border-b border-border/50 bg-card/80">
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Pr&ecirc;t</span>
                </div>
        ...
        <div className="text-center mt-16 pt-10 border-t border-border/20">
          <p className="text-muted-foreground mb-4">Pr&ecirc;t &agrave; cr&eacute;er ton premier clip split-screen ?</p>
          <Link href="/signup">
