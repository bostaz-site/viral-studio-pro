    ...
    <section className="py-20 px-6 border-t border-border/30">
      <AnimatedSection className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Ton stream m&eacute;rite mieux que 12 viewers</h2>
          <p className="text-muted-foreground mt-3 text-lg">Le probl&egrave;me c&apos;est pas ton contenu — c&apos;est le format. Voil&agrave; ce qu&apos;on change.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
          ...
          <div className="relative">
            <div className="absolute -top-3 left-4 z-10">
              <span className="bg-emerald-500/90 text-white text-xs font-bold px-3 py-1 rounded-full">APR&Egrave;S</span>
            </div>
            ...
            <div className="mt-3 space-y-1.5 text-xs pl-2">
              ...
              <div className="flex items-center gap-2"><span className="text-gray-500">Sous-titres :</span><span className="text-emerald-400">Karaok&eacute; MrBeast</span></div>
