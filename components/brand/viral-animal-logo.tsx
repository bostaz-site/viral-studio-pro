...
export function ViralAnimalLogo({ className, iconOnly = false, size = 40 }: ViralAnimalLogoProps) {
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      {/* Wolf head icon — Or Métallique gradient */}
      <svg
        width={size}
        height={size}
        viewBox="0 0 149 183"
