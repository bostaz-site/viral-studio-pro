      ...
      {iconOnly ? null : (
        <>
          ...
          <div className="flex items-baseline gap-1.5 leading-none">
            ...
            <span className="text-sm font-black tracking-wider text-orange-500">ANIMAL</span>
          </div>
        </>
      )}
    </div>
